...
class TrixnityOlmBinariesDirs(project: Project, version: String) {
    val root = project.rootProject.layout.buildDirectory.get().asFile.resolve("trixnity-olm-binaries").resolve(version)
...
class TrixnityOpensslBinariesDirs(project: Project, version: String) {
    val root =
        project.rootProject.layout.buildDirectory.get().asFile.resolve("trixnity-openssl-binaries").resolve(version)
