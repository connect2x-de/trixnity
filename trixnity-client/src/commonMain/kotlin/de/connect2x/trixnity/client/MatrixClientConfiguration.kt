...
data class MatrixClientConfiguration(
    ...
    /**
     * How to handle left rooms. See [DeleteRooms] for the options. When [ForgetForcedUponLeave] is enabled by the
     * homeserver, Trixnity acts like [DeleteRooms.OnLeave].
     */
    ...
    /**
     * Enables storing a queue of notification updates locally to allow using them to update external notifications. To
     ...
     * and override one or more API clients in
     * [de.connect2x.trixnity.clientserverapi.client.MatrixClientServerApiClient].
     *
     * For [serverDiscovery], the standard
     * [de.connect2x.trixnity.clientserverapi.client.MatrixClientServerApiClientImpl] is always used.
     */
    ...
    data class CacheExpireDurations(
        ...
        @MSC4354 val stickyEvent: Duration,
    ) {
    ...
    data class ExperimentalFeatures(
        @MSC3814 var enableMSC3814: Boolean = false,
        @MSC4354 var enableMSC4354: Boolean = false,
    )
