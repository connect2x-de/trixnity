...
internal open class MinimalRepositoryObservableCacheStore<K, V>(private val repository: MinimalRepository<K, V>) :
    ...
    override suspend fun persist(key: K, value: V?) =
        if (value == null) repository.delete(key) else repository.save(key, value)
