...
import de.connect2x.trixnity.client.store.Account as StoredAccount
    ...
    private suspend fun KoinApplication.getDatabase(): Database {
        ...
        val db =
            members.tm.readTransaction {
                ...
                val inboundGroupSession =
                    members.inboundMegolmSessionRepository.getAll().apply { size shouldBe 1 }.first()
