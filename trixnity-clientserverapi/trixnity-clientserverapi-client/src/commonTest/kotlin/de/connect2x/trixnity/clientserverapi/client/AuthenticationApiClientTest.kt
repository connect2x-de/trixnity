...
class AuthenticationApiClientTest : TrixnityBaseTest() {
    ...
    @Test
    fun shouldGetOAuth2ServerMetadata() = runTest {
        val matrixRestClient =
            MatrixClientServerApiClientImpl(
                baseUrl = Url("https://matrix.host"),
        ...
        matrixRestClient.authentication.getOAuth2ServerMetadata().getOrThrow() shouldBe
            ServerMetadata(
    ...
    fun shouldGetEmailRequestTokenForPassword() = runTest {
        ...
        matrixRestClient.authentication
    ...
    fun shouldGetLoginTypes() = runTest {
        ...
        assertEquals(
            setOf(
                LoginType.SSO(setOf(LoginType.SSO.IdentityProvider(id = "oidc-keycloak", name = "FridaysForFuture"))),
                LoginType.Token(),
                LoginType.Password,
            ),
            result,
    ...
    fun shouldDeactivateAccount() = runTest {
        ...
        val result =
            matrixRestClient.authentication
                .deactivateAccount("id.host", false)
                .getOrThrow()
    ...
    fun shouldGetThirdPartyIdentifiers() = runTest {
        ...
        matrixRestClient.authentication.getThirdPartyIdentifiers().getOrThrow() shouldBe
            setOf(
    ...
    fun shouldAddThirdPartyIdentifiers() = runTest {
        ...
        matrixRestClient.authentication.addThirdPartyIdentifiers("d0nt-T3ll", "abc123987").getOrThrow() shouldBe
            UIA.Success(Unit)
    }
    ...
    fun shouldBindThirdPartyIdentifiers() = runTest {
        ...
        matrixRestClient.authentication
            .bindThirdPartyIdentifiers("d0nt-T3ll", "abc123987", "abc123_OpaqueString", "example.org")
            .getOrThrow()
    }
    ...
    fun shouldDeleteThirdPartyIdentifiers() = runTest {
        ...
        matrixRestClient.authentication
            .deleteThirdPartyIdentifiers("example@example.org", "example.org", Medium.EMAIL)
    ...
    fun shouldUnbindThirdPartyIdentifiers() = runTest {
        ...
        matrixRestClient.authentication
            .unbindThirdPartyIdentifiers("example@example.org", "example.org", Medium.EMAIL)
    ...
    fun shouldGetOIDCRequestToken() = runTest {
            ...
            MatrixClientServerApiClientImpl(
                ...
                httpClientEngine =
                    scopedMockEngine {
                        addHandler { request ->
                            assertEquals(
                                "/_matrix/client/v3/user/@user:server/openid/request_token",
                                request.url.fullPath,
                            )
                            assertEquals(HttpMethod.Post, request.method)
                            respond(
        ...
        matrixRestClient.authentication.getOIDCRequestToken(UserId("user", "server")).getOrThrow() shouldBe
    ...
    fun shouldGetToken() = runTest {
        ...
        val result =
            matrixRestClient.authentication.getToken().getOrThrow().shouldBeInstanceOf<UIA.Success<GetToken.Response>>()
        result.value shouldBe GetToken.Response(loginToken = "<opaque string>", expiresInMs = 120000)
    }
}
