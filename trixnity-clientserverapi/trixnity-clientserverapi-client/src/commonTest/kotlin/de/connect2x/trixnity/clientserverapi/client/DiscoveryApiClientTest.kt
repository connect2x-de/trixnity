...
class DiscoveryApiClientTest : TrixnityBaseTest() {
    ...
    fun shouldGetClient() = runTest {
        ...
        matrixRestClient.discovery.getClient().getOrThrow() shouldBe
    ...
    fun shouldGetSupport() = runTest {
        ...
        matrixRestClient.discovery.getSupport().getOrThrow() shouldBe
            GetSupport.Response(
                contacts =
                    listOf(
    ...
    fun shouldGetPolicyServer() = runTest {
        ...
        matrixRestClient.discovery.getPolicyServer().getOrThrow() shouldBe
