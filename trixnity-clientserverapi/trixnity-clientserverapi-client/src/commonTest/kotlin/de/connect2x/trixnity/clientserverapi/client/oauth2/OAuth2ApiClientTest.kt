...
class OAuth2ApiClientTest {
    ...
    fun shouldRegisterClient() = runTest {
        ...
        matrixRestClient.registerClient(clientMetadata).getOrThrow() shouldBe
            ClientRegistrationResponse(clientId = "clientId", clientMetadata = clientMetadata)
    }
    ...
    fun shouldDeviceAuthorization() = runTest {
                ...
                httpClientEngine =
                    scopedMockEngine {
                        addHandler { request ->
                            ...
                            request.body.contentType shouldBe
        ...
        matrixRestClient.deviceAuthorization(clientId = "clientId", deviceId = "deviceId").getOrThrow() shouldBe
    ...
    fun shouldGetRefreshToken() = runTest {
        ...
        matrixRestClient.getRefreshToken(refreshToken = "refresh", clientId = "clientId").getOrThrow() shouldBe
            TokenResponse(
                accessToken = "access",
                refreshToken = "refresh",
                tokenType = "Bearer",
    ...
    fun shouldRevokeToken() = runTest {
                ...
                httpClientEngine =
                    scopedMockEngine {
                        addHandler { request ->
                            ...
                            request.body.toByteArray().decodeToString() shouldBe
                                "token=refresh" + "&token_type_hint=refresh_token" + "&client_id=clientId"
                            request.body.contentType shouldBe
                                ContentType.Application.FormUrlEncoded.withCharset(Charsets.UTF_8)
                            request.method shouldBe HttpMethod.Post
        ...
        matrixRestClient
            .revokeToken(token = "refresh", tokenTypeHint = TokenTypeHint.RefreshToken, clientId = "clientId")
            .getOrThrow()
    }
