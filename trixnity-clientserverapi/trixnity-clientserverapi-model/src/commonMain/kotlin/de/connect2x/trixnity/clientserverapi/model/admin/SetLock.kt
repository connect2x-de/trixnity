...
@HttpMethod(PUT)
data class SetLock(@SerialName("userId") val userId: UserId) : MatrixEndpoint<SetLock.Request, SetLock.Response> {
    @Serializable data class Request(@SerialName("locked") val locked: Boolean)
