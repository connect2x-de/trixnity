...
/**
 * @see <a href="https://spec.matrix.org/v1.10/client-server-api/#put_matrixclientv3room_keysversionversion">matrix
 *   spec</a>
 */
@Serializable
@Resource("/_matrix/client/v3/room_keys/version/{version}")
@HttpMethod(PUT)
data class SetRoomKeyBackupVersionByVersion(@SerialName("version") val version: String) :
