...
internal object Patterns {
     ...
     *
     * List accurate as of 2023/09/11. List taken from: http://data.iana.org/TLD/tlds-alpha-by-domain.txt This pattern
    ...
    /** Regular expression that matches domain names using either [.STRICT_HOST_NAME] or [.IP_ADDRESS] */
    // language=RegExp
    ...
    /**
     * Regular expression to match strings that do not start with a supported protocol. The TLDs are expected to be one
     * of the known TLDs.
     */
    // language=RegExp
    ...
    /**
     * Regular expression to match strings that start with a supported protocol. Rules for domain names and TLDs are
     * more relaxed. TLDs are optional.
     */
    // language=RegExp
    ...
    val AUTOLINK_MATRIX_URI = Regex("""($MATRIX_URI|$WEB_URL_WITH_PROTOCOL|$WEB_URL_WITHOUT_PROTOCOL)""")
}
