    ...
    fun shouldCreateSignatureAuthenticationHeader() = runTest {
        ...
        val cut =
            MatrixServerServerApiClientImpl(
                ...
                sign = {
                    it shouldBe
                        """{"content":{"key":"value"},"destination":"otherHost:80","method":"POST","origin":"myHost","uri":"/test"}"""
                ...
                httpClientEngine =
                    scopedMockEngine {
                        addHandler { request ->
                            request.headers[HttpHeaders.Authorization] shouldBe
                                """X-Matrix origin="myHost",destination="otherHost:80",key="ed25519:ABC",sig="signature""""
