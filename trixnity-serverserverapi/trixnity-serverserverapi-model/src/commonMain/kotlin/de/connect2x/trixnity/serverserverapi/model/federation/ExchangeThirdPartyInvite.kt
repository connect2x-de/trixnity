...
/**
 * @see <a
 *   href="https://spec.matrix.org/v1.10/server-server-api/#put_matrixfederationv1exchange_third_party_inviteroomid">matrix
 *   spec</a>
 */
@Serializable
@Resource("/_matrix/federation/v1/exchange_third_party_invite/{roomId}")
@HttpMethod(PUT)
data class ExchangeThirdPartyInvite(@SerialName("roomId") val roomId: RoomId) :
